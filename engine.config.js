module.exports = {
	...
	"clientConfig": {
		...
		"servers": {
			"portal": "https://domain.example.com/",
			"subdomain" : "https://{s}.example.com/",
			"tiles": {
				"uri": "https://{s}.example.com/v2/tiles/",
				"subdomains": ["tiles-a", "tiles-b", "tiles-c", "tiles-d"]
			},
			"cubes": {
				"uri": "https://{s}.example.com/v2/cubes/",
				"subdomains": ["tiles-a", "tiles-b", "tiles-c", "tiles-d"]
			},
			"proxy" : {
				"uri" : "https://{s}.example.com/v2/tiles/",
				"subdomains" : ["proxy-a", "proxy-b", "proxy-c", "proxy-d"]
			},
			"utfgrid": {
				"uri": "https://{s}.example.com/v2/tiles/",
				"subdomains": ["grid-a", "grid-b", "grid-c", "grid-d"]
			},
		},
		"ga": {
